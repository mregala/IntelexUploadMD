    ...
    public class SubLocation2ToIntelexDelete
    {
        ...
        public async Task SubLocation2ToIntelexDeleteFunc(/*ISubLocation1ExtractHelper _dataExtractHelper*/)
        {
            ...
            if (config != null)
            {
                ...
                string TargetWorksheetNameSubLocation2Delete = config.TargetWorksheetNameSubLocation2Delete;
                ...
                try
                {
                    ...
                    var worksheet = excelPackage.Workbook.Worksheets[TargetWorksheetNameSubLocation2Delete];
                    ...
                    {
                        Console.WriteLine($"Worksheet '{TargetWorksheetNameSubLocation2Delete}' not found in the Excel file.");
                    }
                }
                catch (Exception ex)
                {
